...
public class VendorControllerTest {
    ...
    public void list() {
        BDDMockito.given(vendorRepository.findAll())
                .willReturn(Flux.just(Vendor.builder().firstName("John")
                                .lastName("Doe").build(),
                        Vendor.builder().firstName("Fred")
                                .lastName("Chapell").build()));
    ...
    public void getbyId() {
        BDDMockito.given(vendorRepository.findById("someId"))
                .willReturn(Mono.just(Vendor.builder().firstName("John")
                                .lastName("Doe").build()));
    ...
    public void testCreate(){
        ...
        Mono<Vendor> vendorToSave=Mono.just(Vendor.builder().firstName("firstName").build());
